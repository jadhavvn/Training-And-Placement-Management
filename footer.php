<footer class="section-sm bg-tertiary">
	<div class="container">
		<div class="row justify-content-between">
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						<li class="mb-2"><a href="service-details.html">Training</a>
						</li>
						<li class="mb-2"><a href="service-details.html">Technical Skill</a>
						</li>
						<li class="mb-2"><a href="service-details.html">Interview Scheduling</a>
						</li>
						<li class="mb-2"><a href="service-details.html">Application Tracking</a>
						</li>
						<li class="mb-2"><a href="service-details.html">Placement</a>
						</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						<li class="mb-2"><a href="#!"></a>
						</li>
						<li class="mb-2"><a href="#!">Career Guidance</a>
						</li>
						<li class="mb-2"><a href="#!">Student Stories</a>
						</li>
						<li class="mb-2"><a href="#!">Placements</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-12 newsletter-form">
				<div style="background-color: #F4F4F4; padding: 35px;">
					<h5 class="mb-4 text-primary font-secondary">Our Team</h5>
		...
		<div class="row align-items-center mt-5 text-center text-md-start">
			<div class="col-lg-4">
        <a href="index.html">
          <img loading="prelaod" decoding="async" class="img-fluid" width="160" src="Admin/assets/img/logo_clg.png" alt="Wallet">
        </a>
			</div>
			<div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
				<ul class="list-unstyled list-inline mb-0 text-lg-center">
					<li class="list-inline-item me-4"><a class="text-black" href="privacy-policy.html">Designed By
						<b> Vrushali & Ritika</b></a>
					</li>
