        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body"style="box-shadow: 2px 10px 10px 10px gray;">
              <h5 class="card-title"style="color: blue;font-size: 25px">Applied Student Details</h5>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  {
                    $dname=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM department WHERE ID='".$row[7]."'"));

                    $fstu=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM job_application WHERE STU_ID='".$row[0]."' && JOB_ID='".$_GET['jid']."'"));
                    ...
                    if($fstu[0])
                    {
                      ...
                      <td>'.$dname[1].'</td>
                      <td>
                      <img src ="../Admin/'.$row[1].'" style="height:100px; width:100px">
                      </td>
                      <td>'.$row[2].'</td>
                      <td>'.$row[4].'</td>
                      <td>'.$row[5].'</td>
