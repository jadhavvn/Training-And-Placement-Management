        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body"style="box-shadow: 2px 10px 10px 10px gray;">
              <h5 class="card-title"style="color: blue;font-size: 25px">Job Steps</h5>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php
                  $sr_no=1;
                    $res=mysqli_query($con,"SELECT * FROM job WHERE COM_ID='".$_SESSION['company']."'");
                   while($row=mysqli_fetch_row($res))
                  {
                    $dname=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM department WHERE ID='".$row[1]."'"));
                      echo'<tr>
                      <td>'.$sr_no.'</td>
                      <td>'.$dname[1].'</td>
                      <td>'.$row[4].'</td>
                      ...
                      <td>
                      <a href="delete_job.php?id='.$row[0].'">
