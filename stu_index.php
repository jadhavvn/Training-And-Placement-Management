...
session_start();
 ...
 $sname=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM student WHERE ID='".$_SESSION['student']."'"));
	...
	<div class="container">
		<div class="row">
			<div class="col-8 mx-auto text-center">
				<h2 class="mb-3 text-capitalize">Welcome</h2>
		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="me-lg-4">
                  ...
                  {
                  	$dep=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM job WHERE COM_ID='".$com[0]."'"));
                  	{
                  		if($dep[0])
                  		{
							...
							echo'<div class="col-md-4" data-aos="fade">
								<article class="blog-post">
									<div class="post-slider slider-sm rounded">
										<img loading="lazy" decoding="async" src="Admin/'.$com[1].'" alt="Post Thumbnail">
									</div>
									<div class="pt-4">
										<p class="mb-3">Workinig From - '.$com[4].'</p>
										<h2 class="h4"><a class="text-black" href="job.php">'.$com[2].'</a></h2>
										<p>'.$com[3].'</p> <a href="job.php?cid='.$com[0].'" class="text-primary fw-bold" aria-label="Read the full article by clicking here">Read More</a>
									</div>
								</article>
							</div>';
						}
