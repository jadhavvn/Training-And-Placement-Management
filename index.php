    ...
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="block text-center text-lg-start pe-0 pe-xl-5">
          <h1 class="text-capitalize mb-4">get a fastest Job with a smartest way</h1>
          <p class="mb-4">To enhance the employability of our students in the leading domestic
            and global organizations and provide them the best career opportunity to
            become successful corporate leaders and entrepreneurs in the society </p> <a type="button"
            class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#applyLoan">Apply Now <span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="ps-lg-5 text-center">
          <img loading="lazy" decoding="async"
            src="images/banner/tt.webp"
      ...
      <div class="col-lg-5">
        <div class="section-title">
          ...
          <p class="lead mb-0 mt-4">
            <p>The Training And Placement Guidance Cell is commited to provide all possible assistance to its students to get the best employment opportunities as well as guide them to become successful entrepreneurs in thye future. </p>
            <p>It plays a vital role in shaping the careers of our students by providing need-based skill development and innovative training programs to secure lucrative and higher job roles.</p>
          </p> <a class="btn btn-primary mt-4" href="about.html">Know About Us</a>
        </div>
      </div>
      <div class="col-lg-7 text-center text-lg-end">
        <img loading="lazy" decoding="async" src="images/about-us.webp" alt="About Ourselves" class="img-fluid">
      </div>
    </div>
  </div>
  <div class="has-shapes">
...
<section class="section testimonials overflow-hidden bg-tertiary">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-6">
        <div class="section-title text-center">
          <p class="text-primary text-uppercase fw-bold mb-3">Our Placed Students</p>
          <h1 class="mb-4">Top Stories Of Students</h1>
