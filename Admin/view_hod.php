        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body"style="box-shadow: 2px 10px 10px 10px gray;">
              <h5 class="card-title"style="color: blue;font-size: 25px">HOD Information</h5>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php
                  $sr=1;
                    $res=mysqli_query($con,"SELECT * FROM hod");
                   while($row=mysqli_fetch_row($res))
                  {
                    $dname=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM department WHERE ID='".$row[4]."'"));
                      ...
                      <a href="update_hod.php?id='.$row[0].'">
                      ...
                      <td>
                      <a href="delete_hod.php?id='.$row[0].'">
